...
TEST_F(DockerSpecTest, ParseV2_2ImageManifest)
{
  ...
  EXPECT_EQ(2, manifest->schemaversion());
  EXPECT_EQ(
  ...
  EXPECT_EQ(7023, manifest->config().size());
  EXPECT_EQ(
  ...
  EXPECT_EQ(32654, manifest->layers(0).size());
  EXPECT_EQ(
  ...
  EXPECT_EQ(16724, manifest->layers(1).size());
  EXPECT_EQ(
  ...
  EXPECT_EQ(73109, manifest->layers(2).size());
  EXPECT_EQ(
